        ...
        <div class="newsfeed-container">
          <div class="category-container">
              ...
              <li class="<?= $selectedCat == '' ? 'cat-active' : '' ?>">
                      ...
                      <a href="/dyma/Php/blog_version1/">Tous les articles <span class="small">(<?= count($articles) ?>)</span></a>
                  </li>
                  <?php foreach ($categories as $catName => $catNum) : ?>
                    <li class="<?= $selectedCat ===  $catName ? 'cat-active' : '' ?>">

                      <a href="/dyma/Php/blog_version1/?cat=<?= $catName ?>"> <?= $catName ?><span class="small">(<?= $catNum ?>)</span> </a>
          ...
          <?php else : ?>
            ...
            <div class="articles-container">
                <?php foreach ($articlePerCategories[$selectedCat] as $a) : ?>
                  <a a href="show-article.php?id=<?= $a ['id'] ?>" class="article block">
                    <div class="overflow">
                      <div class="img-container" style="background-image:url(<?= $a['image'] ?>"></div>
                    </div>
                    <h3><?= $a['title'] ?></h3>
